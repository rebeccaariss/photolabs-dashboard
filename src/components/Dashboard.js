...
class Dashboard extends Component {
  ...
  componentDidMount() {
    // Persist state across sessions using local storage in browser:
    ...
    // PhotoLabs API logic (triggered after component [Dashboard] render):
    const urlsPromise = [
      "/api/photos",
      "/api/topics",
  ...
  render() {
    // This solution makes use of the React classnames library:
